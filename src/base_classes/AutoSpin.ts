...
export default class AutoSpin {
    scene: any;
    buttonAuto: Sprite;
    txtAutoSpin: Phaser.GameObjects.DynamicBitmapText;
    ...
    btnExit: Sprite;
    auto: Sprite;
    txtAuto: Phaser.GameObjects.Text;
    txtSpeed: Phaser.GameObjects.DynamicBitmapText;
    ...
    playSpeedAuto() {
        ...
        if(Options.txtAutoSpin === 'STOP') {
            ...
            this.txtAuto = this.scene.add.text(Config.width / 2 - 5, Config.height / 2 - 115,
                String(Options.txtAuto), { fontSize : '35px', color : '#fff', fontFamily : 'PT Serif' });
