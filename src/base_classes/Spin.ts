...
export default class Spin {
    ...
    printResult() {
      ...
      if (autoSpin) {
        s1 = autoSpin.columnTween1.target1;
        s2 = autoSpin.columnTween2.target2;
        s3 = autoSpin.columnTween3.target3;
        s4 = autoSpin.columnTween4.target4;
        s5 = autoSpin.columnTween5.target5;
      } else {
        s1 = baseSpin.columnTween1.target1;
        s2 = baseSpin.columnTween2.target2;
        s3 = baseSpin.columnTween3.target3;
        s4 = baseSpin.columnTween4.target4;
        s5 = baseSpin.columnTween5.target5;
      }
      // push symbols name
      Options.result.push(
        [
          s1.list[3].frame.name,
          s1.list[2].frame.name,
          s1.list[1].frame.name,
        ],
        [
          s2.list[3].frame.name,
          s2.list[2].frame.name,
          s2.list[1].frame.name,
        ],
        [
          s3.list[3].frame.name,
          s3.list[2].frame.name,
          s3.list[1].frame.name,
        ],
        [
          s4.list[3].frame.name,
          s4.list[2].frame.name,
          s4.list[1].frame.name,
        ],
        [
          s5.list[3].frame.name,
          s5.list[2].frame.name,
    ...
    symbolValue(symbolName: any, index: any) {
        switch(symbolName) {
            case 'symbols_0.png':
